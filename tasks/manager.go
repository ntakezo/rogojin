...
// claims — all of it, unless WithMaxRunning bounds the pull — the loop that
// picks up tasks a crashed node left behind once their leases lapse. Losing
// a claim race, a terminal or never-checkpointed record, and a task already
