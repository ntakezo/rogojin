...
func (f *fakeStore) SaveAssignment(ctx context.Context, id string, proxyGroupID, proxyID *string) error {
	return nil
}

func (f *fakeStore) TasksPinnedTo(ctx context.Context, proxyID string) ([]Record, error) {
	return nil, nil
}
